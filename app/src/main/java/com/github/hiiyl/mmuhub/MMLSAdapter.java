...
public class MMLSAdapter extends CursorTreeAdapter {
    ...
    protected Cursor getChildrenCursor(Cursor groupCursor) {
        ...
        //        mCursor.moveToFirst();
        return MySingleton.getInstance(mContext).getDatabase().query(MMUContract.AnnouncementEntry.TABLE_NAME, null,
...
//        ViewCompat.setElevation(childViewHolder.ivHasSeen, 5);
